  ...
  const projects = [
    {
      ...
      category: "web",
      status: "complete",
      tags: ["HTML", "CSS", "JavaScript", "Responsive Design", "React.js", "Framer Motion"],
      ...
      fact: "Built with React.js and Framer Motion with modern design principles!",
      link: "#",
    ...
    },
    {
      ...
      category: "web",
      status: "complete",
      tags: ["JavaScript", "API", "Bookmarklet", "AI", "Hack Club"],
    ...
    },
    {
      ...
      category: "minecraft",
      status: "wip",
      tags: ["Minecraft", "Java", "Speech-to-Text"],
    ...
    },
    {
      ...
      category: "minecraft",
      status: "wip",
      tags: ["Minecraft", "Java", "Collaborative"],
    ...
    },
    {
      ...
      category: "ai",
      status: "complete",
      tags: ["Python", "AI", "Machine Learning", "Math", "NumPy"],
      description: "A complete implementation of neural networks from the ground up, including backpropagation, gradient descent, and various activation functions. Uses the MNIST database of handwritten digits for training and testing.",
      fact: "Built entirely with Python and NumPy - no external ML libraries!",
      link: "https://github.com/mattseq/ScratchNeuralNetwork",
      linkText: "View on GitHub",
      isInternal: false
    },
    {
